              ...
              {!authUser ? (
                <>
                  ...
                  <div className="premium-footer-note">
                    💜 Feito com carinho por <strong>PauloC®</strong> · R$ 19,90/mês após o trial
                  </div>
                </>
              ) : !isPremium ? (
                <>
                  <div className="premium-hero">
                    ...
                    <p style={{fontSize:'0.8rem',color:'var(--text-dim)',marginTop:4}}>Apenas <strong>R$ 19,90/mês</strong> — cancele quando quiser</p>
                  </div>
                  ...
                  <div className="premium-pix">
                    ...
                    <div className="premium-pix-key" onClick={() => { navigator.clipboard?.writeText('02292567083'); showToast('Chave PIX copiada!') }}>
                      <code>02292567083</code>
                      <span className="premium-pix-copy">📋</span>
                    </div>
                    <small className="premium-pix-hint">Toque para copiar a chave</small>
                  </div>
